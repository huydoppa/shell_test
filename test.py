...
tech_stack = ["nextcloud","ubuntu","zimbra","vmware","gitlab","nodejs","laravel","rundeck","wordpress","hadoop","jenkins",
"rancher","adsecurity","hadoop","jenkins","rancher"."openvpn","haproxy","nginx","windows","php","python","elastic","grafana",
"zeroshell","mongodb","struts","clickhouse","redmine","lists.apache.org","airflow","kafka","cakephp","mysql","golang","redis","spring",
"postgresql","pfsense","redash","gearman","atlassian","spark"]
...
def convert(filename, output="output.json"):
    ...
    with open(filename) as json_file:
        ...
        for cves in data["CVE_Items"]:
            ...
            found_items = [item for item in tech_stack and  item in cves["cve"]["references"]["reference_data"]["url"]]
